...
class HomeRepository {
    func requestHomeApi(callback : @escaping(NewsListModel?,ErrorModel?) -> Void){
        let homeRequestUrl = AppConfig.baseUrl+"/v2/top-headlines"
        let params = ["country" : "us","apiKey" : AppConfig.apiKey]
